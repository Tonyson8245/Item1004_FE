<template>
  ...
  <div class="p-5 pb-0">
    <div class="flex items-center">
      ...
      <div
        v-if="unreadCount != 0"
        class="min-w-[1.25rem] w-auto h-5 rounded-full text-center bg-everly-red text-everly-white flex items-center justify-center"
      >
...
import chattingChannel from "./chattingChannel.vue";
...
const { client, channels, unreadCount, selectedChannel, messages } =
