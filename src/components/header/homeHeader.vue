<template>
  <div>
    <div class="border-b-2 bg-[#fafafa]">
      <!-- 웹 팔래요/살래요/검색/등록 -->
      <!-- 검색 : 메인 페이지 & 검색 결과 페이지 -->
      <div class="flex cursor-default inline-block">
        ...
        <div class="flex-none hidden md:block">
          <div
            class="flex-none flex justify-between items-center bg-[#fafafa] w-[1180px] px-4 pt-10 pb-2 relative"
          >
      ...
      <!-- 모바일 배찌 -->
      <div
        class="bg-everly-white cursor-default md:hidden mt-12 z-10 fixed border-b"
      >
        ...
        <div class="bg-[#fafafa] w-[1000px]" v-if="conditionBadge_mobile">
          <div class="flex p-3 space-x-3 h-12 px-6 bg-red-300">
            <!-- 게임머니 베찌 -->
            <div
      ...
      <transition name="slide-down" move="out-in">
        <div
          class="md:hidden absolute fixed w-full bg-everly-white min-h-[700px] h-screen pt-24 flex flex-col"
        ...
        >
          ...
          <div class="flex-none flex w-full justify-end px-5 space-x-3 pb-20">
            <div
      ...
      <div class="flex cursor-default inline-block">
        <div class="flex-1 hidden md:block"></div>
        <div class="flex-none hidden md:block w-[1180px]">
          <div class="flex-none flex justify-center bg-[#fafafa]">
            <div
              class="ml-2 w-[760px] border-everly-main border rounded-lg overflow-hidden bg-everly-white mb-12"
          ...
          <div class="flex w-[1180px]" v-if="!storeShowFilter_web">
...
import filterSearch from "./filtter/searchFilterDropdown.vue";
