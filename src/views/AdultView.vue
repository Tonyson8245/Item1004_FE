    ...
    <div class="flex flex-col mt-16 md:mt-36 px-5 items-center">
        ...
        <div class="flex flex-col items-center md:flex-row md:w-1/2">
            ...
            <div class=" mt-5 flex-col md:ml-5">
                <b class="text-sm">이 정보내용은 청소년 유해매체물로서 [정보통신망이용촉진 및 정보 보호 등에 관한 법률] 및 [청소년 보호법]의 규정에 의하여 19세 미만의 청소년이 이용할 수 없습니다.</b>
                <a href="https://intro.item1004.co.kr/" class="mt-6 border rounded-lg p-3 w-full text-white cursor-pointer bg-black flex justify-center"> <p class=" mr-1 text-everly-yellow">19세미만 </p> 나가기</a>
            </div>
        </div>

        <div class="flex flex-col mt-16 md:w-1/2">
            <div class="flex w-full">
                <img class="w-14 mx-2 md:mx-0 md:w-36" src="@/assets/icon/phone_setification.svg" alt="">
                <div class="ml-5">
                    <b class="text-sm ">본인인증 시 제공되는 정보는 해당 인증기관에서 직접 수집하며, 인증 이외의 용도로 이용 또는 저장하지 않습니다.</b>
                    <button @click="getNiceEncData()" class="mt-6 border rounded-lg p-3 w-full  text-white bg-everly-main justify-center hidden md:block">휴대폰 인증하기</button>
                </div>                             
            </div>
            <button @click="getNiceEncData()" class="mt-6 border rounded-lg p-3 w-full text-white bg-everly-main flex justify-center md:hidden">휴대폰 인증하기</button>
        </div>
