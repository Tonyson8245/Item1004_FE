...
function useColorMode(options = {}) {
  ...
  const store = storageRef || (storageKey == null ? ref(initialValue) : useStorage2(storageKey, initialValue, storage, { window: window2, listenToStorageChanges }));
...
var UseDraggable = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const initialValue = props.storageKey ? useStorage(props.storageKey, resolveUnref(props.initialValue) || { x: 0, y: 0 }, isClient ? props.storageType === "session" ? sessionStorage : localStorage : void 0) : props.initialValue || { x: 0, y: 0 };
